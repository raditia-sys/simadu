...
CREATE TABLE laporan_perjalanan_dinas (
    ...
    tanggal_surat_tugas DATE            NULL      COMMENT 'Tanggal surat tugas',
    tanggal_tugas       DATE            NULL      COMMENT 'Tanggal pelaksanaan tugas',
    tujuan_wilayah_id   INT UNSIGNED    NULL      COMMENT 'FK→master_wilayah (untuk ambil rate_transport_lokal)',
    survei_id           INT UNSIGNED    NULL      COMMENT 'FK→master_survei',
    ...
    status_pengisian    ENUM('draft','selesai') NOT NULL DEFAULT 'draft',
